...
public class TileResult {
    ...
    // Static factory method to create a result from a TileSpec and calculation details
    public static TileResult fromCalculation(TileSpec spec, byte[] imageData, long calculationTimeMs) {
        return new Builder()
                .jobId(spec.getJobId())
